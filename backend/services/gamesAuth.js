...
async function checkToken() {
  ...
  const tokenExpiration = parseInt(process.env.TWITCH_ACCESS_TOKEN_EXPIRATION);
  const tokenLastRequestDate = parseInt(
    process.env.TWITCH_ACCESS_TOKEN_LAST_REQUEST_DATE,
  );
